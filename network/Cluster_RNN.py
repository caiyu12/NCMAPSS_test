...
class Cluster_RNN(nn.Module):
    def __init__(self, configs):
        super(Cluster_RNN, self).__init__()
    ...
    def forward(self, x_enc):
        ...
        x_cd = self.forecast_cd(x_enc)
        x_ci = self.forecast_ci(x_enc)
        x = x_cd * (1-gate) + x_ci * gate
        # print(gate)
    ...
    def forecast(self, x_enc):
        ...
        for cluster_id, channels in self.cluster_map.items():
            ...
            out_group = self.forecast_cd(x_group)  # 所有簇均使用 CD
